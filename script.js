...
var hi=['hi','hello','hi there','hey','heyy','yoo','yo','yooo','yoo there','hi bot','hello there','hi','hiii','hlw','hii','hi anvi','anvi','hello anvi'];
var nmask=['what is my name','what is my name?','what is my name?','What is my name ?','who am i','who am i?','do you know me?','wht is my name','do you know me',"what's my name","what's my name?","do you remember my name","you remember me","tell me my name","do you remember me"," my name"];
var nametl=["what is your name","what is ur name","who are you","what's your name","are you a bot","who made you","who created you","tell me about yourself","what are you","who is your creator",'introduce yourself'];
...
var whatrudng=["what are u do",'what are you upto',"what doing","what are u doing","what are you doing","what are you doing?","what are you doing ?","what r u doing","wht r u doing","what's up","what are thinking","what are you thinking?","kkrh","kya kar rahe ho","kya kar rhi ho","kya kar rahi ho","kya kar rhi  ho"];
...
function getWeatherC()
{
	...
	var gd=$.getJSON(url, gotData).fail(function()
	{
